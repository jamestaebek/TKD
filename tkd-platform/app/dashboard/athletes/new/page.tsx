        ...
        try {
            ...
            if (error) {
                if (error.code === '23505') {
                    ...
                    toast.error('Error al registrar el atleta. Intenta de nuevo.')
                }
            } else {
                toast.success('Atleta registrado exitosamente.')
                setTimeout(() => router.push('/dashboard/athletes'), 1000)
            }
        } catch {
                    ...
                    <div className="max-w-2xl mx-auto">
                        <div className="flex items-center gap-3 mb-6">
                            <button onClick={() => router.push('/dashboard/athletes')}
                                className="text-gray-500 hover:text-white transition text-sm">← Volver</button>
                            <h1 className="text-2xl font-bold">
                                <span className="text-blue-500">TKD</span> — Registrar atleta
                            </h1>
                        </div>
                        ...
                        {step === 1 && (
                            <div className="space-y-4">
                                <div>
                                    <label className="text-sm text-gray-400 mb-1 block">Foto del atleta (opcional)</label>
                                    <div className="flex items-center gap-4">
                                        {form.photo_url ? (
                                            <img src={form.photo_url} alt="" className="w-16 h-16 rounded-xl object-cover border border-[#1e1e2e]" />
                                        ) : (
                                            <div className="w-16 h-16 rounded-xl bg-[#0d0d1a] border border-[#1e1e2e] flex items-center justify-center text-2xl">🥋</div>
                                        )}
                                    ...
                                    <div>
                                        ...
                                        {form.birth_date && age >= 5 && (
                                            <p className="text-blue-400 text-xs mt-1">
                                                {age} años · Categoría: <span className="font-medium">{ageGroup}</span>
                                            </p>
                                        )}
                                    </div>
                                    <div>
                        ...
                        {step === 2 && (
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-xs mt-1">Este es el peso de referencia, no el de competencia</p>
                                </div>
                                {form.birth_date && form.belt_id && form.training_weight && (
                                    <div className="bg-[#0d1a0d] border border-green-900/40 rounded-xl p-4">
                                        <p className="text-xs text-green-400 font-medium mb-2">Categoría calculada automáticamente:</p>
                        ...
                        {step === 3 && (
                            <div className="space-y-4">
                                ...
                                {isMinor && (
                                    <div className="space-y-4 bg-[#0d0d1a] border border-yellow-900/40 rounded-xl p-4">
                                        <p className="text-xs text-yellow-400 font-medium">
                                            El atleta es menor de edad — datos del acudiente
                                        </p>
                                ...
                                <div className="flex gap-3 mt-2">
                                    ...
                                    >
                                        {loading ? 'Guardando...' : 'Registrar atleta ✓'}
                                    </button>
                                </div>
                            </div>
                        )}
